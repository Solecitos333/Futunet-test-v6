    ...
    posCart.forEach((item, index) => {
      ...
      itemEl.innerHTML = `
        ...
        <div class="pos-item-qty-controls">
          <button type="button" class="pos-qty-btn" onclick="CreaticosBilling.changePosCartItemQty(${index}, -1)" aria-label="Disminuir cantidad">-</button>
          <span class="pos-qty-val">${item.qty}</span>
          <button type="button" class="pos-qty-btn" onclick="CreaticosBilling.changePosCartItemQty(${index}, 1)" aria-label="Aumentar cantidad">+</button>
        </div>
