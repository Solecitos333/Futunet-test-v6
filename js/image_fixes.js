...
(function() {
  ...
  var fixes = {
    ...
    'prod_3pe40yw5r':  {img:b+'laminador.webp', dept:'equipos', cat:'Impresoras y Consumibles'},
    ...
    'prod_lg95td0ov':  {img:b+'materiales-ferreteros.webp', dept:'seguridad', cat:'Control de Accesos'},
    ...
    'prod_f754nr1g1':  {img:'img/productos/hikvision-switch-poe-8-2.webp', dept:'redes', cat:'Redes'},
    ...
    'prod_m54v413vd':  {img:b+'pistola-pegamento.webp', dept:'infra', cat:'Remozamiento Profesional'},
    'prod_4fmctb6nd':  {img:b+'pistola-pegamento.webp', dept:'infra', cat:'Remozamiento Profesional'},
    'prod_etnks90ht':  {img:b+'velas-silicon.webp', dept:'infra', cat:'Remozamiento Profesional'},
    'prod_4conwdbfb':  {img:b+'velas-silicon.webp', dept:'infra', cat:'Remozamiento Profesional'},
    'prod_iyd1fr1g0':  {img:b+'union-coupling.webp', dept:'infra', cat:'Remozamiento Profesional'},
    'prod_95tpqs7sz':  {img:b+'union-coupling.webp', dept:'infra', cat:'Remozamiento Profesional'},
    'prod_2rv556wr1':  {img:b+'registro-metal-8x10.webp', dept:'infra', cat:'Remozamiento Profesional'},
    'prod_uivpv4jpm':  {img:b+'registro-octagonal.webp', dept:'infra', cat:'Remozamiento Profesional'},
    'prod_cf3ymk8i3':  {img:b+'tapa-registro.webp', dept:'infra', cat:'Remozamiento Profesional'},
    'prod_zyrnr5dpn':  {img:b+'tuberia-flexible.webp', dept:'infra', cat:'Remozamiento Profesional'},
    'prod_xkna6ugad':  {img:b+'conector-emt.webp', dept:'infra', cat:'Remozamiento Profesional'},
    'prod_yv5qir42u':  {img:b+'conector-emt.webp', dept:'infra', cat:'Remozamiento Profesional'},
    'prod_up2hhi8yx':  {img:b+'tabla-bruta.webp', dept:'infra', cat:'Remozamiento Profesional'},
    'prod_um44r64yv':  {dept:'infra', cat:'Remozamiento Profesional'},
    'prod_jsmff34ie':  {img:b+'materiales-ferreteros.webp', dept:'infra', cat:'Remozamiento Profesional'},
    ...
    'prod_r2n83myqm':  {img:b+'laminados-cristales.webp', dept:'infra', cat:'Remozamiento Profesional'},
    ...
    'prod_w0xr1czq3':  {img:b+'silicon-liquido.webp'},
    ...
    'prod_y1lodb30x':  {img:b+'tabla-acrilica.webp'},
    ...
    'prod_ezp1r691s':  {img:b+'clavos-fulminante.webp'},
    'prod_y2gfa14aq':  {img:b+'fulminante.webp'},
    ...
    'prod_57nl0tl7s':  {img:b+'registro-camaras.webp', dept:'seguridad', cat:'Control de Accesos'},
