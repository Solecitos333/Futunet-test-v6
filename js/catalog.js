...
/**
 * Normaliza y cachea la propiedad del objeto para búsquedas rápidas repetidas
 */
function getNormalized(obj, key) {
  const cacheKey = '_norm_' + key;
  if (obj[cacheKey] === undefined) {
    Object.defineProperty(obj, cacheKey, { value: normalizeSearch(obj[key]), enumerable: false });
  }
  return obj[cacheKey];
}
