...
/**
 * Helper para cachear el texto normalizado en el objeto,
 * evitando procesar regex costosas en cada keystroke.
 */
function getNormalized(obj, key) {
  ...
  Object.defineProperty(obj, cacheKey, { value: val, enumerable: false, writable: true });
  return val;
}
