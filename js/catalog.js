...
/**
 * Helper de memoización para valores normalizados usando WeakMap
 * para evitar mutar el objeto y recompilar los regex en cada búsqueda.
 */
const _normalizeMemo = new WeakMap();
function getNormalized(obj, key) {
  let cache = _normalizeMemo.get(obj);
  if (!cache) {
    cache = {};
    _normalizeMemo.set(obj, cache);
  }
