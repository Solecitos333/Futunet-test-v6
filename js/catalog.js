...
/**
 * Cache normalizado de forma diferida en el propio objeto
 * para evitar recalculos en la busqueda (el cache key se oculta
 * con enumerable: false para no ensuciar la data)
 */
