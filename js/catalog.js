...
/**
 * Normaliza y almacena en caché las propiedades de búsqueda del objeto (como productos)
 * para evitar recalcular regex costosas de forma repetitiva.
 */
function getNormalized(obj, key) {
  let objCache = normalizationCache.get(obj);
  if (!objCache) {
    objCache = {};
    normalizationCache.set(obj, objCache);
  }
