...
/**
 * Normaliza y cachea texto en el objeto para optimizar búsquedas.
 * Usa Object.defineProperty para evitar que el caché sea enumerable.
 */
function getNormalized(obj, key) {
  const cacheKey = `_normalized_${key}`;
