...
/**
 * Obtiene o calcula de manera perezosa el valor normalizado de una propiedad
 * y lo guarda en cache usando Object.defineProperty (no enumerable).
 */
function getNormalized(obj, key) {
  ...
  Object.defineProperty(obj, cacheKey, { value: normalized, enumerable: false, writable: true });
  return normalized;
}
...
function renderCompactMobileCatalogView() {
  ...
  if (state.searchQuery) {
    ...
    for (let i = 0; i < scored.length; i++) results[i] = scored[i].product;
