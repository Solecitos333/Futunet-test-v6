...
/**
 * Obtiene la versión normalizada de una propiedad de un objeto y la cachea
 * para evitar llamadas redundantes a normalizeSearch.
 */
function getLower(obj, key) {
  ...
  if (obj[cacheKey] === undefined) {
    Object.defineProperty(obj, cacheKey, {
      ...
      enumerable: false, // Prevent leakage into iteration/serialization
      configurable: true,
      writable: true
    });
  }
