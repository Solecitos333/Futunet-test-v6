...
/**
 * Obtiene la version normalizada de una propiedad, cacheandola en el objeto para
 * evitar recalculaciones innecesarias durante las busquedas iterativas.
 */
function getNormalized(obj, key) {
  ...
  Object.defineProperty(obj, cacheKey, { value, enumerable: false });
  return value;
}
