...
/**
 * Caché perezoso de strings normalizados en los objetos producto
 * Evita reconstruir con regex las descripciones largas repetidamente
 */
function getNormalized(obj, key) {
  ...
  Object.defineProperty(obj, cacheKey, { value: val, enumerable: false, writable: true, configurable: true });
  return val;
}
